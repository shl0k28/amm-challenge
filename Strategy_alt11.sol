...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MISALIGN_ALPHA_DIV = 2;
    uint256 private constant MISALIGN_VAR_DIV = 2;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (likelyArb) {
            ...
            uint256 alphaP = aligned ? ALPHA_P : (ALPHA_P / MISALIGN_ALPHA_DIV);
            uint256 alphaVar = aligned ? ALPHA_VAR : (ALPHA_VAR / MISALIGN_VAR_DIV);
