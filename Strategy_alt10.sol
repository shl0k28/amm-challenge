...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant FIRST_RETAIL_REBATE_BPS = 6;
    uint256 private constant FIRST_RETAIL_LAMBDA_BONUS_BPS = 6;
    uint256 private constant CARRY_REARM_BPS = 5;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (!firstInStep && shockBps == 0) {
            bidBps += CARRY_REARM_BPS;
            askBps += CARRY_REARM_BPS;
        }
