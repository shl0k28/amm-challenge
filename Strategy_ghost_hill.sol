...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant DIR_DECAY = 750000000000000000; // 0.80
    uint256 constant ACT_DECAY = 600000000000000000; // 0.70
    uint256 constant SIZE_DECAY = 650000000000000000; // 0.70
    uint256 constant TOX_DECAY = 950000000000000000; // 0.80
    uint256 constant SIGMA_DECAY = 600000000000000000; // 0.65
    uint256 constant LAMBDA_DECAY = 996000000000000000; // 0.99
    uint256 constant SIZE_BLEND_DECAY = 750000000000000000; // 0.65
    uint256 constant TOX_BLEND_DECAY = 60000000000000000;
    uint256 constant ACT_BLEND_DECAY = 996000000000000000;
    ...
    uint256 constant TRADE_RATIO_CAP = WAD / 4; // 20%
    ...
    uint256 constant DIR_TOX_COEF = 240 * BPS;
    uint256 constant STALE_DIR_COEF = 6900 * BPS;
    uint256 constant TAIL_KNEE = 500 * BPS;
    uint256 constant TAIL_SLOPE = 820000000000000000; // 0.90
