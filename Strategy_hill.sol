...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant VOL_MULT_BPS = 1065; // hill-climbed on 25-sim objective
    uint256 private constant BASE_MIN_BPS = 17;
    ...
    uint256 private constant ARMOR_MIN_BPS = 119;

    // Fair/vol estimation from likely-arb prints.
    uint256 private constant ARB_MAX_RATIO_WAD = 56 * BPS; // <= 0.52% of reserveY
    uint256 private constant ALPHA_P = 30e16; // 0.35
    ...
    uint256 private constant VOL_BUFFER_DIV = 6; // add sigma/9 as extra band safety
    uint256 private constant SAFE_SIDE_REBATE_BPS = 53;
    ...
    uint256 private constant STREAK_MAX_BPS = 4;

    // Inventory skew around x* = sqrt(k / pHat).
    uint256 private constant INV_SENS_BPS = 254;
    ...
    uint256 private constant TOX_UP_BPS = 2;
    uint256 private constant TOX_DOWN_BPS = 5;
    uint256 private constant TOX_BIG_UP_BPS = 4;
    uint256 private constant CARRY_STEP_BPS = 2;

    // Fee smoothing.
    uint256 private constant ALPHA_SLOW = 84e16; // 0.79
