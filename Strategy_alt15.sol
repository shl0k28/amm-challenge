...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ALPHA_VAR_SLOW = 6e16;
    uint256 private constant ALPHA_VAR_SLOW_RECENTER = 2e16;
    uint256 private constant ALPHA_L = 12e16;
    uint256 private constant ALPHA_RATIO = 12e16;
    uint256 private constant SIGMA_BLEND_FAST = 72e16;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        uint256 sigma = wmul(sigmaFast, SIGMA_BLEND_FAST) + wmul(sigmaSlow, WAD - SIGMA_BLEND_FAST);
        ...
        if (likelyArb) {
            ...
            varSlow = _ewma(varSlow, varEWMA, ALPHA_VAR_SLOW_RECENTER);
        }
