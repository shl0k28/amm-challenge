...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARMOR_LAMBDA = WAD / 4;
    uint256 private constant ARMOR_SIGMA = 10 * BPS;
    uint256 private constant ARMOR_SAFE_FLOOR = 18;
    uint256 private constant ARMOR_VULN_FLOOR = 76;
    uint256 private constant LOW_LAMBDA_1 = WAD / 4;
    uint256 private constant LOW_LAMBDA_2 = WAD / 5;
    uint256 private constant LOW_LAMBDA_SAFE_ADD_1 = 1;
    uint256 private constant LOW_LAMBDA_SAFE_ADD_2 = 2;
    uint256 private constant LOW_LAMBDA_VULN_ADD_1 = 4;
    uint256 private constant LOW_LAMBDA_VULN_ADD_2 = 8;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (lambdaEWMA < LOW_LAMBDA_1) {
            safeBps += LOW_LAMBDA_SAFE_ADD_1;
            vulnFloor += LOW_LAMBDA_VULN_ADD_1;
        }
        if (lambdaEWMA < LOW_LAMBDA_2) {
            safeBps += LOW_LAMBDA_SAFE_ADD_2;
            vulnFloor += LOW_LAMBDA_VULN_ADD_2;
        }
    ...
    function getName() external pure override returns (string memory) {
        return "BandShield_lowLambdaGuard";
    }
