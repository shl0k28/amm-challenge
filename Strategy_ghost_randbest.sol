...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant ACT_DECAY = 650000000000000000; // 0.70
    ...
    uint256 constant LAMBDA_DECAY = 998000000000000000; // 0.99
    uint256 constant SIZE_BLEND_DECAY = 700000000000000000; // 0.65
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 4 * BPS;
    uint256 constant SIGMA_COEF = 300000000000000000; // 0.20
    ...
    uint256 constant DIR_COEF = 10 * BPS;
    uint256 constant DIR_TOX_COEF = 60 * BPS;
    uint256 constant STALE_DIR_COEF = 6900 * BPS;
    uint256 constant TAIL_KNEE = 400 * BPS;
    uint256 constant TAIL_SLOPE = 850000000000000000; // 0.90
    ...
    function getName() external pure override returns (string memory) {
        return "BandShield_ghost_randbest";
    }
}
