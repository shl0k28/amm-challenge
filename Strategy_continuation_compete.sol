...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CONT_TAIL_REBATE_BPS = 5;
    uint256 private constant CONT_COMPETE_BPS = 3;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        // Arbs only trade first in a step. For continuation trades, compete hard for retail flow.
        if (!firstInStep) {
            bidBps = safeBps;
            askBps = safeBps;
            uint256 contCut = CONT_COMPETE_BPS;
