...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ALPHA_P_SLOW = 14e16;
    uint256 private constant ALPHA_P_SLOW_RECENTER = 3e16;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (likelyArb) {
            ...
            pHatSlow = _ewma(pHatSlow, pHat, ALPHA_P_SLOW_RECENTER);
        }
        ...
        if (pHatSlow > 0) {
            if (spot < pHatSlow) {
                uint256 spotOverFair = wdiv(spot, pHatSlow);
                ...
                uint256 fairOverSpot = wdiv(pHatSlow, spot);
