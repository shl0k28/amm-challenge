...
contract Strategy is AMMStrategyBase {
    uint256 private constant MIN_FEE_BPS = 4;
    uint256 private constant MAX_FEE_BPS = 954;
    uint256 private constant MAX_SPREAD_BPS = 852;

    uint256 private constant ARB_MAX_RATIO_WAD = 51 * BPS;
    uint256 private constant ALPHA_P = 27e16;
    uint256 private constant ALPHA_VAR = 20e16;
    uint256 private constant ALPHA_L = 8e16;
    ...
    uint256 private constant SAFE_VOL_MULT_BPS = 1880;
    uint256 private constant SAFE_LAMBDA_SWING_BPS = 18;

    uint256 private constant VULN_MIN_BPS = 58;
    uint256 private constant VULN_SIGMA_DIV = 13;
    uint256 private constant VULN_BUFFER_BPS = 5;
    ...
    uint256 private constant ARMOR_VULN_FLOOR = 54;

    uint256 private constant INV_SENS_BPS = 44;
    uint256 private constant INV_MAX_SKEW_BPS = 45;

    uint256 private constant CONT_ARB_REBATE_BPS = 4;
    uint256 private constant CONT_TAIL_REBATE_BPS = 3;

    uint256 private constant SHOCK_RATIO_WAD = 113 * BPS;
    uint256 private constant SHOCK_BUMP_BPS = 11;
    uint256 private constant SHOCK_DECAY_BPS = 1;
    uint256 private constant SHOCK_MAX_BPS = 10;

    uint256 private constant ALPHA_SLOW = 81e16;
    uint256 private constant ALPHA_FAST = 100e16;

    uint256 private constant RECON_END = 150;
    uint256 private constant ENDGAME_START = 9200;
    uint256 private constant RECON_SAFE_ADD_BPS = 7;
    uint256 private constant RECON_VULN_ADD_BPS = 10;
    uint256 private constant END_SAFE_ADD_BPS = 5;
    uint256 private constant END_VULN_ADD_BPS = 6;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        } else if (trade.timestamp > ENDGAME_START) {
