...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MAX_SPREAD_BPS = 921;

    uint256 private constant ARB_BASE_RATIO_WAD = 11 * BPS;
    uint256 private constant ARB_RATIO_DIV = 1;
    uint256 private constant ARB_SIGMA_DIV = 7;
    uint256 private constant ARB_MAX_CAP_WAD = 121 * BPS;
    uint256 private constant ALPHA_P = 37e16;
    uint256 private constant ALPHA_VAR = 33e16;
    uint256 private constant ALPHA_L = 11e16;
    uint256 private constant ALPHA_RATIO = 17e16;

    uint256 private constant SIGMA_MIN = 7 * BPS;
    uint256 private constant SIGMA_MAX = 24 * BPS;

    uint256 private constant SAFE_BASE_BPS = 0;
    uint256 private constant SAFE_VOL_MULT_BPS = 2403;
    uint256 private constant SAFE_LAMBDA_SWING_BPS = 6;
    uint256 private constant CALM_SIGMA = 10 * BPS;
    uint256 private constant CALM_LAMBDA = 38e16;
    uint256 private constant CALM_SAFE_SHIFT_BPS = 7;
    uint256 private constant CALM_VULN_SHIFT_BPS = 2;
    uint256 private constant STORM_SIGMA = 13 * BPS;
    uint256 private constant STORM_LAMBDA = 26e16;
    uint256 private constant STORM_SAFE_SHIFT_BPS = 2;
    uint256 private constant STORM_VULN_SHIFT_BPS = 9;

    uint256 private constant VULN_MIN_BPS = 58;
    uint256 private constant VULN_SIGMA_DIV = 20;
    uint256 private constant VULN_BUFFER_BPS = 3;
    ...
    uint256 private constant ARMOR_SAFE_FLOOR = 14;
    uint256 private constant ARMOR_VULN_FLOOR = 82;

    uint256 private constant INV_SENS_BPS = 64;
    uint256 private constant INV_MAX_SKEW_BPS = 69;

    uint256 private constant CONT_ARB_REBATE_BPS = 7;
    uint256 private constant CONT_TAIL_REBATE_BPS = 5;

    uint256 private constant SHOCK_RATIO_WAD = 119 * BPS;
    ...
    uint256 private constant STALE_STEP = 18;
    uint256 private constant STALE_SAFE_PER_BPS = 0;
    uint256 private constant STALE_VULN_PER_BPS = 0;
    uint256 private constant STALE_MAX_BPS = 13;
    uint256 private constant STALE_REBATE_GUARD_BPS = 886;

    uint256 private constant ALPHA_SLOW = 80e16;
