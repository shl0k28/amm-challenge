...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant RECON_END_TS = 180;
    uint256 private constant RECON_SAFE_ADD_BPS = 1;
    uint256 private constant RECON_VULN_ADD_BPS = 8;
    uint256 private constant ENDGAME_START_TS = 9650;
    uint256 private constant END_SAFE_ADD_BPS = 2;
    uint256 private constant END_VULN_ADD_BPS = 5;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (trade.timestamp < RECON_END_TS) {
            safeBps += RECON_SAFE_ADD_BPS;
            vulnFloor += RECON_VULN_ADD_BPS;
        } else if (trade.timestamp > ENDGAME_START_TS) {
            safeBps += END_SAFE_ADD_BPS;
            vulnFloor += END_VULN_ADD_BPS;
        }
