...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant SAFE_VOL_MULT_BPS = 2347;
    ...
    uint256 private constant RECON_END_TS = 188;
    uint256 private constant RECON_SAFE_ADD_BPS = 2;
    uint256 private constant RECON_VULN_ADD_BPS = 10;
    uint256 private constant ENDGAME_START_TS = 9681;
    uint256 private constant END_SAFE_ADD_BPS = 3;
    uint256 private constant END_VULN_ADD_BPS = 7;

    uint256 private constant INV_SENS_BPS = 137;
    uint256 private constant INV_MAX_SKEW_BPS = 39;

    uint256 private constant CONT_ARB_REBATE_BPS = 4;
    uint256 private constant CONT_TAIL_REBATE_BPS = 2;

    uint256 private constant SHOCK_RATIO_WAD = 93 * BPS;
    uint256 private constant SHOCK_BUMP_BPS = 5;
